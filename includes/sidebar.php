...
<div class="list-group list-group-flush my-3">
    ...
    <i class="far fa-calendar-plus me-2"></i>Add Course
    </a>
    ...
    <i class="fab fa-font-awesome-flag me-2"></i>Add Class
    </a>
    ...
    <a href="user-list.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold <?php if($page=='user-list') {echo 'active';} ?>">
